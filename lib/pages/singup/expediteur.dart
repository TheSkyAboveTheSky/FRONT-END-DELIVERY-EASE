...
class SignUpAsExpediteur extends StatefulWidget {
  const SignUpAsExpediteur({Key? key});

  @override
  _SignUpAsExpediteurState createState() => _SignUpAsExpediteurState();
}

class _SignUpAsExpediteurState extends State<SignUpAsExpediteur> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Container(
          padding: const EdgeInsets.fromLTRB(30, 30, 30, 70), // Adjust the bottom padding
